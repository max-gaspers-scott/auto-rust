...
COPY --from=builder /app/target/release/auto-rust ./
COPY --from=builder /app/migrations ./migrations
COPY --from=frontend-builder /app/frontend/build ./frontend/build

# Ensure the binary is executable
RUN chown -R appuser:appuser /app && chmod +x /app/auto-rust
...
# Copy compiled binary & any runtime assets (e.g. migrations)
COPY --from=builder /app/target/release//home/mgs/auto-rust ./
COPY --from=builder /app/migrations ./migrations
COPY --from=frontend-builder /app/frontend/build ./frontend/build

# Ensure the binary is executable
RUN chown -R appuser:appuser /app && chmod +x /app//home/mgs/auto-rust
